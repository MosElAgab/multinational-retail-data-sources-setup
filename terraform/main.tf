...
resource "aws_api_gateway_integration" "lambda_integration" {
  rest_api_id = aws_api_gateway_rest_api.store_api.id
  resource_id = aws_api_gateway_resource.number_of_stores.id
  http_method = aws_api_gateway_method.get_number_of_stores.http_method
  integration_http_method = "POST"
  type = "AWS_PROXY"
  uri = aws_lambda_function.get_number_of_stores.invoke_arn
}


## lambda invoke permission for the api integration
